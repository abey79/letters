...
CI renders preview, axial-cutaway and through-boss PNGs into the
`karcher-wd2-adapter` workflow artifact
(`build/docs/preview.png`, `build/docs/cutaway.png`, `build/docs/boss.png`).
